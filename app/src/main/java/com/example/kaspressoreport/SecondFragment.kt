...
import com.example.kaspressoreport.databinding.FragmentSecondBinding
...
class SecondFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.openFlakyButton.setOnClickListener {
            findNavController().navigate(R.id.action_SecondFragment_to_flakyFragment)
        }
